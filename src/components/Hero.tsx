...
import { ArrowDown, Sparkles, Play, Zap, Star } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in-up">
          ...
          <div className="flex justify-center mb-6">
            <div
              className={`inline-flex items-center px-6 py-3 rounded-full text-sm font-medium backdrop-blur-md border transition-all duration-500 hover:scale-110 ${
                isDark
          ...
          >
            ...
            <span
              className={`block bg-gradient-to-r animate-text-shimmer ${
                isDark
          ...
          {/* Subtitle */}
          <p
            className={`text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate-fade-in-up-delay ${
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <a
              href="#projects"
              className={`group relative px-8 py-4 rounded-full font-semibold text-lg transition-all duration-500 transform hover:scale-110 overflow-hidden ${
                isDark
